...
export default function WithdrawStake() {
  ...
  const getBalanceComponents = (bankInfo) => {
    ...
    return bankInfo.data.staked[currencyDest]
  }
  ...
  const sendExchangeRequest = () => {
    ...
    //fetch(`http://localhost:8080/v2/redeem-LPT`, requestOptions)
    fetch(`${hostAddress}/redeem-LPT`, requestOptions)
        ...
        <Card>
          <form onSubmit={handleSubmit}>
            <Stack spacing={4}>
              <FormControl mr="5%" isRequired>
                ...
                <Flex align={'stretch'}>
                  <Input as={CurrencyInput}
                    // defaultValue={getBalanceComponents(bankInfo)}
                    mr={"5px"} minW={"75%"}
              ...
              <Flex align={"start"}>
                <Button colorScheme='blue' type="submit">Withdraw Stake</Button>
              </Flex>
            </Stack>
